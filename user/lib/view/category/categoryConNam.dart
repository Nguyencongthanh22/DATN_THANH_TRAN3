...
class CategoryNam2 extends StatefulWidget {
  const CategoryNam2({super.key, required this.Id_cha});
  final int? Id_cha;

  @override
  State<CategoryNam2> createState() => _CategoryNamState();
}

late Future<List<Product>> futureCategorynam;

class _CategoryNamState extends State<CategoryNam2> {
