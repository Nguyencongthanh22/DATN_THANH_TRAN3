                      ...
                      return FutureBuilder<List<Coupon>>(
                        ...
                        builder: (context, snapshotCoupon) {
                          if (snapshotCoupon.connectionState ==
                            ...
                            return Center(
                                child: Text('Error: ${snapshotCoupon.error}'));
                          }
                                              ...
                                              ? Column(children: [
                                                  Text(
                                                    ...
                                                    style: TextStyle(
                                                        decoration:
                                                            TextDecoration
                                                                .lineThrough, decorationThickness: 2.0,fontSize: 18,),
                                                  ),
                                                  Text(formatCurrency(
                                                      discountedPrice),style: TextStyle(color: Colors.red,fontSize: 22,fontWeight: FontWeight.bold),)
                                                ])
                                              ://SizedBox(height: 10,),
                                               Text(
                                                  formatCurrency(originalPrice),style: TextStyle(color: Colors.red,fontSize: 22,fontWeight: FontWeight.bold))
                                        ],
                                      ),
                                    ),
                                  );
