...
class _CateloryState extends State<Catelory2> {
  ...
  List<int> categorycap = [1]; // Danh sách các id danh mục
  List<Category?> categories = []; // Danh sách các danh mục từ API
  List<int> categoryIdsNam = [14, 15, 16, 17, 18, 19, 20, 21];
  List<int> categoryid_chaNam = [1];
  List<int> categorycapNam = [2]; // Danh sách các id danh mục
  List<Category?> categoriesNam = [];
  List<int> categoryIdsNu = [5, 6, 7, 8, 9, 10, 11, 12, 13];
  List<int> categoryid_chaNu = [2];
  List<int> categorycapNu = [2]; // Danh sách các id danh mục
  List<Category?> categoriesNu = [];
  List<int> categoryIdsTe = [22, 23, 24, 25, 26, 27, 28, 29, 30];
  List<int> categoryid_chaTE = [3];
  List<int> categorycapTE = [2]; // Danh sách các id danh mục
  List<Category?> categoriesTE = [];
  List<int> categoryIdsBB = [31, 32];
  List<int> categoryid_chaBB = [4];
  List<int> categorycapBB = [2]; // Danh sách các id danh mục
