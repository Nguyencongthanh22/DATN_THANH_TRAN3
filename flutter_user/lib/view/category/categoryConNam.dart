...
class CategoryNam extends StatefulWidget {
  const CategoryNam({super.key, required this.Id_cha});
  final int? Id_cha;

  @override
  State<CategoryNam> createState() => _CategoryNamState();
}

class _CategoryNamState extends State<CategoryNam> {
